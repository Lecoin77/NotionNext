...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，We're Trading, Servers/Laptop/Desktop',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kevin', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Marketer', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://itad.yuankevin.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, ITAD, Trade IT assets Servers,Laptop,Desktop,Networking', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'hello@yuankevin.com', // 邮箱地址 例如mail@tangly1024.com
